		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello",
									"targetURL": "#uxhelloworld-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uxhelloworld-display": {
								"semanticObject": "uxhelloworld",
								"action": "display",
								"description": "First program using UI5 framework",
								"title": "Hello",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux.helloworld",
									"url": sap.ui.require.toUrl("ux/helloworld")
								}
							}
						}
					}
