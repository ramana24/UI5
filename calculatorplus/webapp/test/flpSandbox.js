		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Calculator",
									"targetURL": "#uxcalculatorplus-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uxcalculatorplus-display": {
								"semanticObject": "uxcalculatorplus",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux.calculatorplus",
									"url": sap.ui.require.toUrl("ux/calculatorplus")
								}
							}
						}
					}
